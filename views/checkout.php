...
$hotelImage = '../public/photos/economy.jpg'; 
foreach ($selectedProducts as $product) {
...
<div class="container d-lg-flex">
        ...
        <div class="box-2">
            <div class="box-inner-2">
                ...
                <form action="package-action.php">
                    <div class="mb-3">
                        ...
                        <div class="address">
                           ...
                           <br></br>
                            ...
                            <div class="d-flex flex-column dis">
                                ...
                                <button type="submit" class="btn btn-primary mt-2">Pay<span class="fas fa-dollar-sign px-1"></span>
    </button>
                            </div>
                        </div>
                    </div>
